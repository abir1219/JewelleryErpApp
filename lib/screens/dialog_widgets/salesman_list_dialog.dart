...
class SalesmanListDialog extends StatefulWidget {
  const SalesmanListDialog({super.key});
...
class _SalesmanListDialogState extends State<SalesmanListDialog> {
              ...
              child: Column(
                children: [
                  ...
                  AppWidgets.buildSearchableField(
                      size, "Search Salesman Code,Salesman name", null,
                      isEnabled: true),
                  Gap(size.height * 0.05),
                  Expanded(
                    child: ListView.builder(
                      itemBuilder: (context, index) {
                        return _buildSalesmanContainer(index, size);
                      },
                      itemCount: 10,
                    ),
                  )
  ...
  Widget _buildSalesmanContainer(int index, Size size) {
    return Container(
